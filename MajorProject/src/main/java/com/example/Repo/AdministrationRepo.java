...
public interface AdministrationRepo extends JpaRepository<Administration,Long>{
	...
	@Query(value="select ip from administration where ipstatus='Alloted'",nativeQuery=true)
	public List<Administration> getAllAllocatedIps();
	
	@Query(value="select count(ipnumber) from administration where ipstatus='Alloted'",nativeQuery=true)
...
//	@Transactional
	...
	@Query(value="select * from administration where ipstatus='Alloted'",nativeQuery=true)
	public List<Administration> findByIpstatus();
