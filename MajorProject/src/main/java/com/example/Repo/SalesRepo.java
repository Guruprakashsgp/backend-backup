...
public interface SalesRepo extends JpaRepository<Sales,Long> {
	...
	@Query(value="select count(ipnumber) from sales where ipstatus='Alloted'",nativeQuery=true)
...
//	@Transactional
	...
	@Query(value="select * from sales where ipstatus='Alloted'",nativeQuery=true)
	public List<Sales> findByIpstatus();
}
